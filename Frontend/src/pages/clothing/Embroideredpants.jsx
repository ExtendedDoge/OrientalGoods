...
import { ClothingTest2 } from "../../data.js"
...
const Embroideredpants = () => {
  return (
    <Container>
      ...
      <Wrapper>
        <ImgContainer>
        {ClothingTest2.map(item=>(
            <Image src={item.img}/>
        ))}
        </ImgContainer>
        <InfoContainer>
            <Title>Unisex Floral Embroidered Pants</Title>
...
export default Embroideredpants