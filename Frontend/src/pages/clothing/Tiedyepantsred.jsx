...
import { ClothingTest5 } from "../../data.js"
...
const Tiedyepantsred = () => {
  return (
    <Container>
      ...
      <Wrapper>
        <ImgContainer>
        {ClothingTest5.map(item=>(
            <Image src={item.img}/>
        ))}
        </ImgContainer>
        <InfoContainer>
            <Title>Tie-Dye Loose Pants</Title>
